...
OoO_SV<int>& Torus_3D_Arrive::getPacketQueueSV() {
...
void Torus_3D_Arrive::Run(std::list<OoO_Event*>& newEvents, double simTime, std::shared_ptr<Entity> entity) {
    ...
    if (_intraArrival) {
        ...
        // Calculate wrapped coordinates for destination
        ...
        packet = std::make_shared<Torus_3D_Packet>(simTime, _networkNodeID, dest_network_node_ID,
